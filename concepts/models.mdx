---
title: "Defining Firestore Models with Pydantic"
sidebarTitle: "Models"
...
Every `BaseFirestoreModel` subclass automatically gains an `id` field defined as `Optional[str] = None`. It maps directly to the Firestore document ID.
